...
<link href="/static/community/notice/noticeSearch.css?i=1" rel="stylesheet">
<style>
@font-face {
...
<body>
		...
		<table class="table-border" style="border-collapse: collapse;">
			...
			<tr>
				...
				<td colspan="5" style="height: 300px;">
					<div class="content"
						style="max-height: 100%; width: 98.5%; margin: 5px;" readonly>${result.content }</div>
				</td>
			</tr>
	...
	<form action="/deleteNotice" method="post" class="deleForm">
			...
			<table class="modal-table">
				...
				<tr>
					<td id="modal_td"><button type="button" onclick="modal_out2()">취소하기</button></td>
				</tr>
			</table>
		</form>
