...
<section>
    ...
    <form style="width:65%" method="post" action="/noitceModify1?id=${notice.id}" enctype="multipart/form-data" >  
      <table class="notiTable" >
        ...
        <tr>
          ...
          <td class="ntd" colspan="3">&nbsp;<input type="text"  id="title" name="title"  style="width: 90%;" value="${notice.title }"/></td>
        </tr>
        <tr>	
          <td class="fchild ntd">
            내용
