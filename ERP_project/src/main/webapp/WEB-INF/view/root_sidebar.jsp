...
<body>
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="position: absolute; top: 100px; height: 80%;">
      ...
      <div class="dropdown">
        <a href="#" class="d-flex align-items-center link-dark text-decoration-none dropdown-toggle" id="dropdownUser2"
          ...
          <img src="https://github.com/tkdwns0016.png" alt="" width="100" height="100" class="rounded-circle me-2">
          <strong>김상준</strong>
        </a>
  ...
  <script>
    ...
    var v = document.getElementsByClassName("list_none");
    topper[0].onclick = function () {
      $(".menu0").slideToggle(1);
    }
    topper[2].onclick = function () {
      $(".menu2").slideToggle(1);
    }
    topper[5].onclick = function () {
      $(".menu5").slideToggle(1);
    }
  </script>
</body>
