		...
		<tbody>
			<tr>
				...
				<table border="0" cellpadding="1" cellspacing="1" width="100%">
						<form action="/accountSearch" method="post"></form>
						<tbody>
							<tr>
								...
								<td width="82%" bgcolor="#FFFFFF"><input name="search"
									...
									value="검색" name="submit1" style="CURSOR: hand"></td>
							</tr>
					...
					<table align="center" border="0" width="100%">
						<tbody>
							...
							<c:forEach var="sr" items="${search}">
								<tr onclick="sendChildValue('${sr.accountName}')">
									<td>${sr.accountName }</td>
									<td>${sr.accountCode }</td>
									<td>${sr.accountNumber }</td>
									<td>${sr.accountOwner }</td>
									<td>${sr.accountLocation }</td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
