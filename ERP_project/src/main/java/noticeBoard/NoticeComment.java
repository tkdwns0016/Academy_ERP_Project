...
public class NoticeComment {
	...
	public NoticeComment(int id, int boardId, String comment, int writerId, String writerName,
	...
	public String toString() {
		return "NoticeComment [id=" + id + ", boardId=" + boardId + ", comment=" + comment + ", writerId=" + writerId
